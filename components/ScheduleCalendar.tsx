/**
 * ScheduleCalendar — scheduling distribution tool rendered inside a Sheet.
  ...
  return (
    <div className="flex flex-col gap-3 h-full overflow-y-auto">
      ...
      {selectedTrigger ? (
        ...
        <p className="text-xs text-muted-foreground">
          Select a trigger below to set its next review date.
        </p>
      )}
      ...
      {/* Trigger list — select one to reschedule */}
